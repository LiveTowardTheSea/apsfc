	...
	<table width="100%" height="1" border="0" cellpadding="0"
		...
		<tr>
			<td valign="top" bgcolor="#F7F8F9">
				...
				<div align="center">
					<form
						action="${pageContext.request.contextPath }/MenusServlet?method=update&currentPage=${currentPage}"
						...
						<table id="table2" class="line_table"
							...
							<tr>
								<td class="line_table" height="25" align="right" width="20%">
									<span class="left_bt2">菜单名称：</span>
								</td>
								<td class="line_table" height="25" width="70%">
									<input type="text" name="name" size="45" value="${menu.name}" >
								</td>
							</tr>
								...
								<td class="line_table" height="25" width="80%">
									<select	name="typeid">
										<c:forEach items="${typesList}" var="item">
											<c:choose>
												<c:when test="${menu.typeid eq item.id}">
							...
							<tr>
								<td class="line_table" align="right" width="20%">
									<span class="left_bt2">展示图片</span>：
								</td>
								<td class="line_table" width="80%" align="left">
									<img src="${pageContext.request.contextPath }/${menu.imgpath}" />
