    ...
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          ...
          <li><a href="${pageContext.request.contextPath}/OrdersServlet?method=search" target="main">销售订单查询</a></li>
          <li><a href="${pageContext.request.contextPath }/OrdersServlet?method=findSales" target="main">本日销售额统计</a></li>
        </ul>
      </div>
    </div>
