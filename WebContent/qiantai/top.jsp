						...
						<div style="padding: 0px">
							<div id="topmenu">
								<c:choose>
									...
									<c:otherwise>
										欢迎您<a href="${pageContext.request.contextPath}/qiantai/center.jsp" target="_self" style="color:blue"><u>${user.name}</u></a> &nbsp;| 
									</c:otherwise>
								</c:choose>
								...
								<c:choose>
									...
									<c:otherwise>
										<a href="javascript:void(0)" target="_self">会员注册</a>| 
									</c:otherwise>
								</c:choose>
								...
								<c:choose>
									...
									<c:otherwise>
										<a href="javascript:void(0)">注销退出</a>| 
									</c:otherwise>
								</c:choose>
							...
							<div id="menu">
								...
								<div id="mainmenu">
									<ul>
										...
										<li><a href="${pageContext.request.contextPath}/IndexServlet?method=findOrders" target="_self">我的订单</a></li>
